...
st.markdown(
    "<h1 style='text-align: center; background-color: #333333; padding: 10px; color: #F0FFFF;'><b>Your Loan Approval</b></h1>",
    unsafe_allow_html=True
)

st.image("https://p7.hiclipart.com/preview/820/449/181/business-loan-peer-to-peer-lending-finance-bank-financial-business.jpg", )
...
requestloanamt = st.slider("Loan Amount", min_value=1000, max_value=500000, step=1000)
...
#EmploymentSector = st.selectbox("Employment Sector", ['Consumer Discretionary', 'Information Technology', 'Energy', 'Consumer Staples', 'Communication Services', 'Materials' 'Utilities', 'Real Estate', 'Health Care', 'Industrials', 'Financials', "Unknown"])
