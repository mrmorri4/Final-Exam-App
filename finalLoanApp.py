...
# Assuming FICOscoregroup is a set, and only one option is intended to be selected
fico_group_str = list(FICOscoregroup)[0] if FICOscoregroup else '' # Handle empty set if possible
print(fico_group_str)
